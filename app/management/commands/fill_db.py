...
def add_payments():
    ...
    for _ in range(30):
        ...
        add_payment(status, roads, owner, moderators)

    add_payment(1, roads, users[0], moderators)
    add_payment(2, roads, users[0], moderators)

    print("Заявки добавлены")


def add_payment(status, roads, owner, moderators):
